...
int main()
{
    ...
    ADD_TEST(STA_COLLECTION, T_STA_ZPX);
    ADD_TEST(STA_COLLECTION, T_STA_AB);
    ADD_TEST(STA_COLLECTION, T_STA_ABX);
    ADD_TEST(STA_COLLECTION, T_STA_ABY);
    ADD_TEST(STA_COLLECTION, T_STA_INX);
    ADD_TEST(STA_COLLECTION, T_STA_INY);
